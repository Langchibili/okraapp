...
// //     >
// //       {rideRequest? <View style={styles.overlay}>
...
// //                   ⭐ {rideRequest.rider?.rating?.toFixed(1) || '5.0'} •{' '}
...
//   // ✅ Modal always renders — null guard is INSIDE, not before the Modal wrapper.
//   // This ensures the Modal mounts and animates correctly even if rideRequest
//   // arrives in a separate render cycle from the `open` flag.
//   return (
//     <Modal
//       visible={open}
//       transparent
...
//                 <View style={styles.avatar}>
//                   <Text style={styles.avatarText}>
//                     {(rideRequest.riderName || rideRequest.rider?.name || 'R')[0]?.toUpperCase()}
//                   </Text>
//                 </View>
//                 <View style={styles.riderInfo}>

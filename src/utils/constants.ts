...
//   // Device Registration Events  ← new
//   DEVICE: {
...
//   // Native / WebView bridge Events  ← new (camelCase — these are bridge events, not REST)
//   BRIDGE: {
...
//     PONG:                 'pong',
//     ERROR:                'error',
//     CONNECT_ERROR:        'connect_error',   // ← new
...
//   CONSTANTS,
// };
// utils/constants.js  (native app — shared across driver, rider, conductor, delivery webviews)
